...
vcf_neutral=4-Downstream_Analyses/tables/ll_wholegenome_LyCa_ref.sorted.filter7.neutral.vcf
...
plink_1.9 --vcf $sd_cand_vcf \
 ...
 --recode A --out 4-Downstream_Analyses/tables/sd_candidate_snps

# qvals candidate snps:
plink_1.9 --vcf $qvals_cand_vcf \
 --double-id --allow-extra-chr --set-missing-var-ids @:# \
 --remove 4-Downstream_Analyses/tables/samplestoremove.txt --geno 0 \
 --recode A --out 4-Downstream_Analyses/tables/qvals_candidate_snps
...
--out 4-Downstream_Analyses/tables/neutral_pruned
# neutral snps:
plink_1.9 --vcf $vcf_neutral \
 --double-id --allow-extra-chr --set-missing-var-ids @:# \
 ...
 --recode A --out 4-Downstream_Analyses/tables/neutral_snps
